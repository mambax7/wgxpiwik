...
class __TwigTemplate_bcf376ee561cc6c74470024afc7c7e3a3f0913d9251a8fe77a1aff56864cd997 extends Twig_Template
{
        ...
        if ((isset($context["fileUploadEnabled"]) ? $context["fileUploadEnabled"] : $this->getContext($context, "fileUploadEnabled"))) {
            ...
            if ((isset($context["logosWriteable"]) ? $context["logosWriteable"] : $this->getContext($context, "logosWriteable"))) {
                ...
                echo "                    <div class=\"alert alert-warning uploaderror\" style=\"display:none;\">
                        ";
                // line 208
                echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreAdminHome_LogoUploadFailed")), "html", null, true);
                echo "
                    </div>
                    <div class=\"form-group\">
